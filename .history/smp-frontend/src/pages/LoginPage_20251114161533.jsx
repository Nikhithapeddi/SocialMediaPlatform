...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const userResponse = await axios.get(`http://localhost:8082/users/${formData.email}`);
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center px-6 relative overflow-hidden">
      ...
      {/* Left Side - Info */}
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-center items-start relative z-10 pr-12">
